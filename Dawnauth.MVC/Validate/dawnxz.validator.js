Dawn.Validator = {
    ...
    ----    电话号码
    ----------------------------------------------------------*/
    TelIsPhone: function (chkObj, msgObj, icoObj, info) {
        var result = this.Exec(chkObj, msgObj, icoObj, info, 'TelIsTelephone');
        if (result == 0) {
            result = this.Exec(chkObj, msgObj, icoObj, info, 'TelIsMobile');
        }
        return result;
    },
    ...
    TelIsMobile: function (chkObj, msgObj, icoObj, info) {
        return this.Exec(chkObj, msgObj, icoObj, info, 'TelIsMobile');
    },
