...
namespace DawnXZ.HDWM.WebSite.Filters
{
    ...
    /// 模块功能验证过滤器
    /// </summary>
    public class ModuledFilter : AuthorizeAttribute
    {
        ...
        /// <param name="functionMark">模块功能标识</param>
        /// <param name="tipsMode">
        /// 消息提示模式
        /// <para>1 正常窗体模式</para>
        /// <para>2 弹出窗体模式</para>
        ...
        public ModuledFilter(string moduleCode, int functionMark, byte tipsMode = 1, int seqOrder = 1001)
        {
            TipsMode = tipsMode;
            Order = seqOrder;
